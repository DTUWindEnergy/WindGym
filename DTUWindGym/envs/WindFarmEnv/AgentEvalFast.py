...
def eval_single_fast(env, model, 
    ...
    ds = xr.Dataset(
        data_vars={
            #For agent:
            "powerF_a": (("time", "ws", "wd", "TI", "turbbox", "model_step"), powerF_a),          #Power for the farm: [time, turbine, ws, wd, TI, turbbox]
            "powerT_a": (("time", "turb", "ws", "wd", "TI", "turbbox", "model_step"), powerT_a),  #Power pr turbine [time, ws, wd, TI, turbbox]
            "yaw_a": (("time", "turb", "ws", "wd", "TI", "turbbox", "model_step"), yaw_a),        #yaw is array of: [time, turbine, ws, wd, TI, turbbox]
            "ws_a": (("time", "turb", "ws", "wd", "TI", "turbbox", "model_step"), ws_a),          #Ws at each turbine: [time, turbine, ws, wd, TI, turbbox]
            ...
            #For environment
            "reward": (("time", "ws", "wd", "TI", "turbbox", "model_step"), rew_plot),            #Reward 
            # "pct_inc": (("time", "ws", "wd", "TI", "turbbox", "model_step"), pct_inc),            #Percentage increase in power output
